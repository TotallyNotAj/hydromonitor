...
const points = ref(10); // Specify the num of points on the live graph together.
...
const CreateCharts = async () => {
  ...
  tempHiChart.value = Highcharts.chart("container", {
    ...
    subtitle: {
      text: `The heat index is a measure of how hot it actually feels to the human body when relative humidity is combined with the air temperature, often refered to as the "apparent temperature". It indicates the difficulty the body has cooling itself through perspiration, as higher humidity level prevent sweat evaporation and make temperatures feel significantly hotter than the actual air temperature.`,
      style: { color: "#FFFFFF" },
    },
    yAxis: {
      title: {
